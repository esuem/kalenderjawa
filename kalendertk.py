...
def f_b4():
    try:
        ...
        l42['text'] = x.pendhak(dina=3)
        l43['text'] = x.pendhak(dina=7)
        l44['text'] = x.pendhak(dina=40)
        l45['text'] = x.pendhak(dina=100)
        l46['text'] = x.pendhak(taun=1)
        l47['text'] = x.pendhak(taun=2)
        l48['text'] = x.pendhak(dina=1000)
    except Exception:
        messagebox.showerror('Kesalahan!', 'Cek input anda!')
